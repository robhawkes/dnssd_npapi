...
# DNS Service Discovery Plugin project
#\**********************************************************/
...
target_link_libraries(${PROJECT_NAME}
    ...
    $ENV{BONJOUR_SDK_HOME}/lib/win32/dnssd.lib
    )
...
add_wix_installer( ${PLUGIN_NAME}
    ${CMAKE_CURRENT_SOURCE_DIR}/Win/WiX/DNSSDPluginInstaller.wxs
    PluginDLLGroup
...
link_directories($ENV{BONJOUR_SDK_HOME}/lib/win32)
link_directories($ENV{BONJOUR_SDK_HOME}/lib/win64)